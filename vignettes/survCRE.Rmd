---
title: Fit survival causal rule ensemble (survCRE)
author: Ke WAN
date: '`r format(Sys.time(), "%y/%m/%d %H:%M")`'
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Fit survival causal rule ensemble (survCRE)}
...
```{r, echo = TRUE, message = FALSE, warning = FALSE, results = "asis", out.width = "95%"}
...
```{r, echo = TRUE, message = FALSE, warning = FALSE, fig.height = 5, fig.width = 10, out.width = "95%"}
## Variable importance
